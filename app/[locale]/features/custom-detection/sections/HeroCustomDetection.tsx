...
export default function HeroCustomDetection({ dict }: Props) {

    const t = dict.customDetection.hero;
                ...
                <div className="relative">
                    ...
                    <div className="rounded-2xl bg-white shadow-xl border border-gray-100 p-6">
                        ...
                        <div className="mt-4 space-y-2 text-sm text-gray-600">
                            <div>🚶 {t.preview.person}</div>
                            <div>🚗 {t.preview.car}</div>
                            <div>🐶 {t.preview.dog}</div>
                            <div>📦 {t.preview.object}</div>
                        </div>
